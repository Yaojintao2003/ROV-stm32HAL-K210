...
void Motor_Set(unsigned char MotorID,int AddSpeed)
{
    ...
    {
    case Motor_AW:
        __HAL_TIM_SetCompare(HMotor_PB1, CMotor_PB1, MidStatus+AddSpeed);//fanle  yjt
        break;
    case Motor_DW:
        __HAL_TIM_SetCompare(HMotor_PB0, CMotor_PB0, MidStatus-AddSpeed);
        break;
    case Motor_AS:
        __HAL_TIM_SetCompare(HMotor_PA7, CMotor_PA7, MidStatus-AddSpeed);		//反了-->+  yjt
        break;
    case Motor_DS:
        __HAL_TIM_SetCompare(HMotor_PA6, CMotor_PA6, MidStatus-AddSpeed);		
        break;	
    case Motor_LE :
        __HAL_TIM_SetCompare(HMotor_PA3, CMotor_PA3, MidStatus-AddSpeed);		//反了-->+  yjt
        break;
    case Motor_RI:
...
#define Yaw_Key		1
#define High_Key	1
int Base_Speed =300 ; //270 300 350 325 310
...
#if Roll_Key
#define Roll_KP All_KP*8//All_KP
...
#if High_Key
#define High_KP 35  //8//All_KP*4    //4
#else
#define High_KP 0
#endif
#define High_KI 0.6//0
#define High_KD (High_KP/1000.)

//#define Line_x_KP	   yjt
//#define Line_x_KI	0
//#define Line_x_KD	0.5

#define Line_x_KP	10//yjt   2
#define Line_x_KI	20
#define Line_x_KD	0.8

#define Line_Angle_KP	0.8//1 //10
#define Line_Angle_KI	13
...
//		Motor_Set(Motor_AW,900);
//		Motor_Set(Motor_DW,900);
//		Motor_Set(Motor_AS,900);
//		Motor_Set(Motor_DS,900);


	//	Motor_Set(Motor_RI,Base_Speed+Yaw_Gyro_PID.out);
	Motor_Set(Motor_LE,Base_Speed+Line_Angle_PID.out-Line_x_PID.out);
  Motor_Set(Motor_RI,Base_Speed-Line_Angle_PID.out+Line_x_PID.out);
//	Motor_Set(Motor_LE,1200);
//  Motor_Set(Motor_RI,1200);
