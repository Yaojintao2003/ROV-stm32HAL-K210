...
void Blue(int num,int RGB_Time)//蓝色闪烁num次,间隔  RGB_Time_Delta   ms
{
	int i=0;
	for(i=0;i<num;i++)
	{
...
void Green(int num,int RGB_Time)//绿色闪烁num次,间隔  RGB_Time_Delta   ms
{
	int i=0;
	for(i=0;i<num;i++)
	{
...
void Yello(int num,int RGB_Time)//黄色闪烁num次,间隔  RGB_Time_Delta   ms
{
	int i=0;
	for(i=0;i<num;i++)
	{
...
void Red(int num,int RGB_Time)//红色闪烁num次,间隔  RGB_Time_Delta   ms
{
	int i=0;
	for(i=0;i<num;i++)
	{
...
//		else if(0.5 < Target_Flag_Filter.out && Target_Flag_Filter.out < 1.5 && RGB_Flag != 0 && Line_Key == 0)	//啥也看不到
//		{
//			WS_WriteAll_RGB(0, 0, 0);
//			RGB_Flag = 0;
//			Grap(0);
//			osDelay(1000);
//		}
//		else if(0.5 < Target_Flag_Filter.out && Target_Flag_Filter.out < 1.5 && RGB_Flag != 3 && Line_Key == 1)	//只看到管子
//		{
