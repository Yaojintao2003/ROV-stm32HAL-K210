...
{	
	...
	OLED_ShowString(0,2,"Distance:",12);
	OLED_ShowString(60,3,"R: ",12);	
	OLED_ShowString(1,3,"L: ",12);
}

void OLED_Show(void)
{
		OLED_Float(0,56,pitch,2);	
		OLED_Float(1,48,BatteryVoltage,2);						//显示电压
		OLED_ShowNum(80,3,Encoder_Right,3,12);					//显示右边电机的编码器值
		OLED_ShowNum(20,3,Encoder_Left,3,12);					//显示左边电机的编码器值
		OLED_Float(2,70,1000,2);						//显示超声波的距离
}
